...
const Memories = () => {
  ...
  const memories = [
    {
      ...
      description: "Where moments become memories and love stories are written in light. Each frame captures the unspoken promises, the stolen glances, and the beautiful chaos of your special day.",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1537633552985-df8429e8048b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
      description: "Life's most precious celebrations frozen in time. From the first cry to golden anniversaries, we preserve the laughter, tears, and joy that make your journey unforgettable.",
    ...
    },
    {
      ...
      description: "Unleashing the artistry within every soul. Transformative portrait sessions that reveal the unique beauty and personality shining through each individual story.",
    ...
    },
    {
      ...
      description: "Where grand visions meet flawless execution. Capturing the scale and intimacy of your most significant events with cinematic precision and emotional depth.",
  ...
  return (
    <section ref={sectionRef} className={`memories-section ${isVisible ? 'visible' : ''}`} id="memories">
      <div className="memories-container">
        ...
        <div className="memories-grid">
          {memories.map((memory, index) => (
            <div
              key={memory.id}
              className={`memory-card ${activeMemory === index ? 'active' : ''} ${isVisible ? 'animate-in' : ''}`}
